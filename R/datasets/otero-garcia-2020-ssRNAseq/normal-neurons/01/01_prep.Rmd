...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(
    ...
    unlist(strsplit(getwd(), "/"))[8], unlist(strsplit(getwd(), "/"))[9], "01_prep.html"
  ))})
---
...
This analysis focuses on normal neurons without neurofibrillary tangles (NFTs) from the dataset.
...
analysis_no <- unlist(strsplit(getwd(), "/"))[8]
assets_dir <- file.path("..", "..", "..", "...", "assets") # Backed up files and data.
results_dir <- file.path("..", "..", "..", "..", "results", data_name, unlist(strsplit(getwd(), "/"))[7], analysis_no)

cache_dir <- file.path("..", "..", "..", "..", "cache", data_name, unlist(strsplit(getwd(), "/"))[7], analysis_no)

...
# ------------------------------------------------------------------------------------
rds <- file.path(assets_dir, "pseudobulk.rds")
if (file.exists(rds)) {
  sce <- readRDS(rds)
} else {
...
png(file.path(results_dir, "02_genefunnel_network.png"), 150, 150, "in", res = 72)
...
plot(
    ...
    vertex.label.cex = ifelse(DE == "yes", ((all_DE_match$Freq + 1) * 1.25), 2),
